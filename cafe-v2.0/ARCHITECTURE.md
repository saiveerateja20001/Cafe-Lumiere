# ☕ Café Lumière v2.0 - System Architecture (Enhanced)

## Overview

Café Lumière v2.0 is an enhanced microservices-based café management application with three core services:
